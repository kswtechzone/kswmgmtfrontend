        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', margin: 0 }}>
              {website ? `Live subdomain preview: https://${website.subdomain}.kswhospitality.com` : 'No website deployed for this organization yet.'}
            </p>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          {website ? (
            <>
              ...
              <a 
                href={`https://${website.subdomain}.kswhospitality.com`} 
                target="_blank" 
          ...
          <div style={{ 
            ...
            <div style={{ background: '#1e293b', padding: '12px 20px', display: 'flex', alignItems: 'center', gap: '12px', borderBottom: '1px solid #334155' }}>
              ...
              <div style={{ background: '#0f172a', padding: '6px 16px', borderRadius: '8px', color: '#94a3b8', fontSize: '0.85rem', flex: 1, fontFamily: 'monospace', marginLeft: '12px' }}>
                https://{website.subdomain}.kswhospitality.com
              </div>
            </div>
